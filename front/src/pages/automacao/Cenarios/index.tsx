        ...
        {Object.keys(funcionalidades[key]).length === 0 && (
          <div style={{ display: 'flex', justifyContent: 'space-between', gap: '5px' }}>
            <Tooltip title="Editar cenários da funcionalidade">
              <IconButton onClick={handleFuncionalidadeButtonClick}>
...
function handleFuncionalidadeButtonClick(event: React.MouseEvent<HTMLButtonElement>) {
  ...
  return (
    <div>
      <div className="flex items-center pb-10">
        <h1 className="pr-5" style={{ fontSize: '1.5rem', fontWeight: 'bolder' }}>Automação / Cenários</h1>
